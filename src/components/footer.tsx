...
const Footer = () => {
  return (
    <footer className="flex flex-col items-start px-8 py-6 bg-grey-darkHover text-white">
      <div className="text-xs-bold mb-2">2025 덕성여자대학교 IT미디어공학전공 제13회 졸업전시회 웹사이트</div>
