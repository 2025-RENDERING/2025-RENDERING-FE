...
export const PROJECT_LIST: ProjectItem[] = [
  ...
  },
  {
    ...
    projectDescription:
      "AI가 만들어 내는 수많은 이미지 속, 인간의 흔적은 어디에 있을까? ‘화록’은 생성형 AI의 창작 과정에서 인간의 창의적 개입을 추적한다. 프롬프트 한 줄에 담긴 생각과 시도를 따라가며, DPDT (이중 경로 발산적 사고) 이론을 바탕으로 인간의 창의성을 탐구한다.",
    projectIntent:
  ...
  },
  {
    ...
    listTitle: "MoodPix",
    title: "MoodPix",
    oneLineDescription: "실시간 감정분석을 활용한 VTuber 인터랙션 시스템",
    ...
    projectIntent:
      "VTuber 방송은 감정 표현이 수동 제어에 의존해 몰입감이 떨어진다. MoodPix는 실시간 감정 인식 AI를 통해 자연스럽고 몰입감 있는 캐릭터 인터랙션을 구현하고자 한다.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    teamName: "뚜벅뚜벅",
    listTitle: "MotionSync VR",
    title: "MotionSync VR - 움직임으로 이동하는 몰입형 체험",
    oneLineDescription: "딥러닝 기반 모션 인식형 VR 인터랙션 시스템",
    tags: ["딥러닝", "NUI", "VR 체험"],
  ...
  },
  {
    ...
    projectIntent:
      "환경 문제의 인식을 넘어 내 공간에서 직접 실천하는 경험으로 확장하고자 기획했다. 현실 공간을 재현한 디지털 트윈 환경에서 쓰레기를 줍고 분류하며, 별도의 미니게임을 통해 환경오염으로 위기에 처한 동물을 구출한다. 이를 통해 환경 보호의 의미를 되새길 수 있다.",
  },
  {
    id: 9,
    ...
    projectDescription: `매일 반복되는 "오늘 뭐 먹지?"라는 고민을 AI 챗봇과의 즐거운 채팅으로 해결해 주는 플랫폼이다. Bapick!은 오늘의 운세를 분석하고 사용자와의 대화를 통해 행운의 메뉴와 맛집을 제공하여 특별한 하루를 선물한다.`,
    projectIntent: `다양해진 현대인의 식문화 속 ‘AI 챗봇’이라는 대화형 인터페이스를 통해 딱딱한 정보 검색 과정을 '친구와 대화하는 듯한' 즐거운 경험으로 전환하는 것을 목표로 한다. 사용자의 식성과 같은 명시적 정보와 운세 같은 감성적 정보를 종합적으로 분석하여, 맞춤형 맛집 추천 서비스를 제공한다.`,
  },
  {
    id: 10,
  ...
  },
  {
    ...
    projectDescription: `‘몽글(mongle)’은 AI가 아동의 HTP(House-Tree-Person) 그림을 분석해 심리적 특성을 도출하는 확장형 검사(AI-HTP)이다. 인공지능이 그림의 구조·형태·색채를 정량화해 내면의 감정과 성향을 시각적으로 탐색하는 차세대 심리 진단 서비스이다.`,
  ...
  },
  {
    ...
    listTitle: "Dorememe",
    title: "Dorememe",
    oneLineDescription: "VR 기반 다중 감각 체험형 전시",
    tags: ["VR 체험", "음악감상", "Sketch2Music"],
    members: ["박서정", "서정윤", "안소정", "정다현"],
    projectDescription: `VR 속 계절별 테마 공간에서 그림을 그리면 색상·명도·브러쉬 크기와 위치·지우기 사용 횟수 등이 음악 생성 파라미터로 전달된다. 추출된 특징을 기반으로 멜로디를 생성하고, 다양한 스타일을 더한 음악을 완성한다. 그림과 음악을 함께 감상하는 다중 감각 체험형 콘텐츠를 제공한다.`,
    projectIntent: `비대면 실감형 콘텐츠가 일상화되면서 VR·AR 기반의 학습·치료 도구에 대한 수요가 확대되고 있다. 본 작품은 시각 중심의 기존 흐름을 넘어 시청각을 융합한 다중 감각 경험을 제안하며, 사용자가 능동적으로 참여해 개인화된 감각 공간을 구축한다는 점에서 새로운 가능성을 보여준다.`,
  },
  {
    id: 14,
    thumbnailImageUrl: Thumb14,
    teamName: "토깽이",
    listTitle: "Emotion Catcher",
  ...
  },
  {
    ...
    teamName: "DS버스터즈",
    listTitle: "젤리 버스터즈 : 지구를 지켜라",
    title: "젤리 버스터즈 : 지구를 지켜라",
    oneLineDescription: "실시간 날씨 API와 챗봇을 활용한 환경보호 슈팅게임",
    tags: ["실시간 날씨 API", "AI 챗봇", "환경보호 슈팅게임"],
    members: ["김다은", "고지원", "나예원"],
    projectDescription: `‘젤리 버스터즈: 지구를 지켜라’는 언리얼 엔진으로 제작된 환경보호 슈팅게임이다. 지구온난화로 탄생한 오염 젤리를 퇴치하며, 사용자는 게임을 통해 환경보호의 필요성을 체험적으로 배운다.`,
  ...
  },
  {
    ...
    teamName: "wave to 덕",
    listTitle: "Digital Panopticon",
    title: "Digital Panopticon : 잠들지 않는 눈과 귀",
